...
export class UserAnalysisComponent implements OnInit {
  ...
  meassurements: PaginationWrapper<Measurement>;
  meassurements$ = this.measurementStore.select(selectAllMeasurements);
  ...
  ngOnInit() {
    ...
    this.currentUser$.subscribe(user=>{
      ...
      if(this.currentUser?.id!=null){
        this.request.parameters = { userId: this.currentUser?.id }
        this.measurementStore.dispatch(new LoadAllMeasurements({requestParams:this.request }) );
      }
